...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('general_permission', models.TextField(choices=[('read', 'Read'), ('write', 'Write'), ('custom', 'Custom')], default='no_change', help_text='Read/Write general permission', verbose_name='General Permission')),
                ('extra_info', models.JSONField(blank=True, default=dict, encoder=pumpwood_communication.serializers.PumpWoodJSONEncoder, help_text='Other information that can be usefull', verbose_name='Extra info')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Updated At', verbose_name='Updated At')),
                ('custom_permission', models.ForeignKey(help_text='Pemission Policy that will be applied to the group', on_delete=django.db.models.deletion.CASCADE, related_name='policy_group_set', to='api_permission.pumpwoodpermissionpolicy', verbose_name='Group')),
